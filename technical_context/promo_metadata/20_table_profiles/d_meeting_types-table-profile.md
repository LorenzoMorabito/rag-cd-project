# d_meeting_types — Table Profile

## Role
Dimension table used to slice the promotional fact.

## Structural metadata
- full name: `dev_iqvia_catalog.trusted_starschema_01.d_meeting_types`
...
## Column groups
- business keys: `MEETING_TYPE_ID`
- measures: none
- non-key attributes: `MEETING_TYPE`

## Inbound relationships
- used by `f_channel_dynamic_data.MEETING_TYPE_ID` (declared_metadata_fk)

## Column inventory

|   position | column_name     | type_name   | nullable   | semantic_role       |
|-----------:|:----------------|:------------|:-----------|:--------------------|
|          0 | MEETING_TYPE_ID | LONG        | False      | business_key        |
|          1 | MEETING_TYPE    | STRING      | False      | attribute           |
